    ...
    return (
        <nav className="sticky top-0 -z-50 bg-gradient-to-r from-[#273b1a] to-[#3b4c26]">
            <div className="container mx-auto lg:flex flex-wrap items-center justify-between px-3">
                <div className="lg:w-1/4 sticky top-0 flex justify-between lg:static lg:justify-start h[10vh]">
                    ...
                    <div className="flex items-center">
                        <button className="cursor-pointer text-xl text-white leading-none px-3 py-1 h-[3rem] block lg:hidden outline-none focus:outline-none" onClick={() => setNavbarOpen(!NavbarOpen)}>
                            {NavbarOpen ? <AiOutlineClose /> : <FaBars />}
                        </button>
                    </div>
                </div>
                <div className={"lg:flex flex-grow lg:items-center items-baseline lg:h-auto h-[90vh] justify-center lg:w-3/4" + (NavbarOpen ? " flex" : " hidden")}>
